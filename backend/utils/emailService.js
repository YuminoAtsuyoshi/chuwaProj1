...
const sendEmail = async (address, token) => {
  try {
    const info = await transporter.sendMail({
      ...
      text: `Thank you for joining our company.\nPlease use the following token and link to register in our employee management system to provide your information and files. This token is valid for 3 hours.\nToken: ${token}\nLink: https://localhost:5173/register?token=${token}`,
